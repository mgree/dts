  structure Object: OBJECT =
    ...
    fun LIST_UNTAG (ref (LIST l)) = l |
        ...
        LIST_UNTAG d = raise TypeError ("list", 
    fun INPUT_PORT_UNTAG (ref (INPUT_PORT iport)) = ipor
        INPUT_PORT_UNTAG d = raise TypeError ("input port", d)
    fun OUTPUT_PORT_UNTAG (ref (OUTPUT_PORT oport)) = opor
    ...
    fun is_equal (ref (BOOL b), ref (BOOL b')) = (b = b') |
	   ...
	   in if Vector.length v = Vector.length 
