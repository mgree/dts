...
(define (coercion type1 type2)
  ; returns coercion type1->type2 and adds correspondin
  ; constraints
...
(define (coercion-show c)
  ; returns a displayable representation of 
...
(define (normalize-global-constraints!
  ...
  (set! global-equality-constraint
...
(define (equiv! tv1 tv2)
  ...
  (let ((tv1-rep (find! tv1)
    ...
    (cond
     ...
     (else ; tv1-rep and tv2-rep are distinct, nondynamic class representative
	...
	(if (and tv1-con tv2-con
	    ...
	    (link! tv1-rep tv2-rep))))))
  '()
(define (equiv-with-dynamic! t
  ; equivalences type tv with dynami
  (let ((tv-rep (find! tv))
