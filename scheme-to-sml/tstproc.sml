...
fun read_def() =
let
val ud = parse_def std_in (* parse input stream into a 
                             preattributed definition *) 
val ad = make_attributes_def ud topenv 
	     (* translate preattributed expression 
                into attributed definition *)
val ae = case ad of DEFINE (_, ae) => ae
         (* extract expression part from definition *)	     
val kd1 = display_def ad
val t = unify_type_def ad (* unify types according to 
                             local equational type rules *)
